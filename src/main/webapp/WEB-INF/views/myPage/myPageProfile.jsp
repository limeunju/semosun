		...
		<div class="jsx-2255473334 layout" style="margin-top: 50px;">
			...
			<div class="jsx-2255473334 content">
				...
				<div id="updateProgress">
		            <p><strong class="accent-color">나의 강의 성향 스타일은?</strong></p>
					...
					<div class="row">
						<div>
		                 ...
		                 <div>
		                    <input type="range" max="5" min="0" step="1" name="score1" onchange="changeProgress(this);" value="${member.score1}">
		                 </div>   
					    </div>
					<div class="row">
						<div>
					        <div class="progress-label"> 유머러스한 강의를 좋아하시나요? </div><br />
					        <div class="progress">
		                 ...
		                 <div>
		                    <input type="range" max="5" min="0" step="1"  name="score2" onchange="changeProgress(this);" value="${member.score2}">
		                 </div>   
					    </div> 
					<div class="row">
						<div>
					        <div class="progress-label"> 과제가 많은 수업을 좋아하시나요? </div><br />
					        <div class="progress">
		                 ...
		                 <div>
		                    <input type="range" max="5" min="0" step="1"  name="score3" onchange="changeProgress(this);" value="${member.score3}">
		                 </div>   
					    </div> 
					<div class="row">
						<div>
					        <div class="progress-label"> 교재가 많은 수업이 좋으신가요? </div><br />
					        <div class="progress">
		                 ...
		                 <div>
		                    <input type="range" max="5" min="0" step="1" name="score4" onchange="changeProgress(this);" value="${member.score4}">
		                 </div>    
					    </div> 
					<div class="row"> 
						<div>
					        <div class="progress-label"> 발음, 발성, 속도의 강도가 어떤<br>강사님을 좋아하시나요? (차분 ↔ 파워풀)   </div><br />
					        <div class="progress">
		                 ...
		                 <div>
		                    <input type="range" max="5" min="0" step="1" name="score5" onchange="changeProgress(this);" value="${member.score5}">
		                 </div>   
					</div>
		       		</div>
	              </div>
