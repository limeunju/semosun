...
<body>
							...
							<table id="tbl-board" class="table table-striped table-hover" style="text-align:center;">
								...
								<c:forEach items="${list}" var="r">
									<tr id="${r.rno}">
										...
										<td><input type="hidden" value="${r.rno}" /></td>
										<td onclick="selectOne(${r.rno}, ${r.userNo});">${r.rno}</td>
										<td onclick="selectOne(${r.rno}, ${r.userNo});">${r.ref_content}</td>
										<td onclick="selectOne(${r.rno}, ${r.userNo});">${r.nickName}</td>
										<td onclick="selectOne(${r.rno}, ${r.userNo});">${r.ref_date}</td>
										<td onclick="selectOne(${r.rno}, ${r.userNo});"></td>
	...
	<script>
		function LoadImg(value) {
 		...
 		function selectOne(rno, ruserNo){
			console.log("있니??" + rno);
			location.href = "${pageContext.request.contextPath}/reportView.do?rno=" + rno + "&userNo=" + ruserNo;
		};
